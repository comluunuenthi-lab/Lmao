...
function generateUserAgent() {
  const userAgent = new UserAgent({
    deviceCategory: randList(['desktop', 'mobile', 'tablet']),
    platform: randList(['Win32', 'MacIntel', 'Linux x86_64', 'iPhone', 'Android']),
  });
...
const separator = parsedTarget.search ? "&" : "?";
headers[":path"] = parsedTarget.pathname + parsedTarget.search + separator + randstr(10) + "=" + randstr(5);
